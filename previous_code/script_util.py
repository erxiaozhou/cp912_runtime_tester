...
import random
import struct
from extract_dump import at_least_one_can_execute
...
def tc_executable(tc_path):
    ...
    dumped_results = exec_one_tc(impls, tc_path, tc_result_dir, tc_result_dir)
    return at_least_one_can_execute(dumped_results)

...
def _get_paras():
    ...
    if len(argv) == 1:
        result_base_dir = 'executable_checking_result/i64_eqz'
        result_base_dir = 'executable_checking_result/executable_96_part'

        ori_tcs_dir = './ori_tcs/fi64_eqz'
        ori_tcs_dir = '../spec/extract_document/test_tcs/i64_eqz'
        ori_tcs_dir = 'ori_tcs/executable_96_part'
    else:
        try:

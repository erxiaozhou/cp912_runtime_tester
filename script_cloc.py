...
exculde_dir = [
    'results', 'tt', 'v1_main_script', 'ori_tcs', 'tt.py', 'test_one.py', 'script_compare_log_inv_file.py', 'run_five.py', 'run_one_tc_std_testing.py', 'imlp_paras.py', 'tests', 'check_ori_tcs_executable.py', 'py_wasm2wat.py', 'debug_util', 'for_motivation_example', 'for_motivation_example_main.py', 'final_findings', 'script_cloc.py', 'analyze_difference', 'analyze_difference_main.py', 'exec_five.py', 'special_tcs', 'run_dir_std_testing_no_mutation_main.py', 'impl_paras_std_release.py'
]

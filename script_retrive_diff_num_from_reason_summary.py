...
from file_util import read_json, save_json, dir_file_num
...
class reason_related_c:
    def __init__(self, base_dir):
        ...
        self.ctgy_info = read_json('./inst2ctgys.json')
    ...
    def count_by_compare_nan(self, key, th, ctgy=None, get_ori_names=False, can_run_runtimes=None):
        ...
        skp_list = read_json('./to_skip_names.json')
        c = Counter()
        name_dict = dict()
...
def execution_abortion_difference():
    ...
    mutation_reason = reason_related_c('/media/hdd_xj1/cp910_data/main_testing_v17_340_9811')

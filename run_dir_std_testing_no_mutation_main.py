...
if __name__ == '__main__':
    ...
    # 
    tested_dir = '/media/hdd_xj1/cp910_data/existing_diff_tcs'
    result_base_dir = '/media/hdd_xj1/cp910_data/existing_diff_tcs_result_0331'
    # 
    tested_dir = '/media/ssd_wd1/cp910_data/main_testing_v14.1_550_9811_p10MC/except_dir'
    result_base_dir = 'tt/tmp_r'
    #
    analyze_paths = analyze_result_dirs(result_base_dir)
    paras, exec_paths = get_no_mutation_paras(result_base_dir, tested_dir)
    paras.update({'check_result_dir_not_exist': False})
    paras.update({'remove_tc':True})
    ...
    log_content_categorize(paths['only_exec'], analyze_paths.log_category_base_dir, exec_paths.dumped_data_base_dir, ['only_interesting', 'only_highlight'])

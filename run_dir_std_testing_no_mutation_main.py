...
def get_paras(result_base_dir, tested_dir):
    one_tc_limit=00
    mutate_num=0
    reason_base_dir = result_base_dir +  '/reasons'
    ...
    paras = {
        ...
        'reason_base_dir': reason_base_dir,
        'one_tc_limit': one_tc_limit,
        'mutate_num': mutate_num,
        'skip_common_diff': False,
        'add_mutation': False
    }
    return paras, reason_base_dir, reason_summary_path
...
def general_main():
    ...
    paras, reason_base_dir, reason_summary_path = get_paras(result_base_dir, tested_dir)
    test_with_mutation(**paras)
    reason_base_dir2reason_summary_json(reason_base_dir, reason_summary_path)
